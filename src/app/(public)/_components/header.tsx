    ...
    const NavLinks = () => (
        <>
            ...
            {status === 'loading' ? (
                ...
                <Link
                    className="flex items-center justify-center gap-2 bg-gray-900 text-white py-1 rounded-md px-4"
                    href="/dashboard"
                >
                    Acessar clinica
                </Link>
    ...
    return (
        <header className="fixed top-0 right-0 left-0 z-[999] py-4 px-6 bg-white">
            <div className="container mx-auto flex items-center justify-between">
                <Link href="/public" className="text-3xl font-bold text-zinc-900">
